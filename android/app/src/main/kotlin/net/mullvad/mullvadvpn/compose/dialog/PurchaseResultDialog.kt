...
private fun PreviewPurchaseResultDialogPurchaseStarted() {
    AppTheme {
        PurchaseResultDialog(purchaseResult = PurchaseResult.PurchaseStarted, onTryAgain = {})
    }
}
...
private fun PreviewPurchaseResultDialogVerificationStarted() {
    AppTheme {
        PurchaseResultDialog(purchaseResult = PurchaseResult.VerificationStarted, onTryAgain = {})
    }
}
...
private fun PreviewPurchaseResultDialogPurchaseCompleted() {
    AppTheme {
        PurchaseResultDialog(purchaseResult = PurchaseResult.PurchaseCompleted, onTryAgain = {})
    }
}
...
@Composable
fun PurchaseResultDialog(purchaseResult: PurchaseResult, onTryAgain: () -> Unit) {
    var showPurchaseDialog by remember { mutableStateOf<PurchaseDialog?>(null) }

    val onClose = { showPurchaseDialog = null }
    ...
    when (showPurchaseDialog) {
        ...
        // Pending state
        PurchaseDialog.PurchasePending -> PurchasePendingDialog(onClose = onClose)
        // Success state
        PurchaseDialog.PurchaseCompleted -> PurchaseCompletedDialog(onClose = onClose)
        // Error states
